...
namespace NwaySetAssociativeCacheTests
{
    public class NwaySetAssociativeCacheTest
    {
        ...
        {
            ICache<string, string> cache = new NwaySetAssociativeCache<string, string>(5, 3, ReplacementAlgorithms.Lru);
            ...
            Assert.Equal("Bad3", cache.Get("Always"));
